...
# print("The command ever jumps into main.py")
def parse(args):
    ...
    parser_train.add_argument('--override', help='override model', action='store_true', default=True)
    parser_train.add_argument('--val-annotations', metavar='path', type=str,
                              help='path to COCO style validation annotations', default="retinanet/data/annotations/person_keypoints_val2017.json")
    parser_train.add_argument('--val-images', metavar='path', type=str, help='path to validation images', default="/workspace/retinanet-examples/retinanet/data/val")
    parser_train.add_argument('--post-metrics', metavar='url', type=str, help='post metrics to specified url')
    parser_train.add_argument('--fine-tune', metavar='path', type=str, help='fine tune a pretrained model', default=False)
    parser_train.add_argument('--logdir', metavar='logdir', type=str, help='directory where to write logs', default="./log")
    ...
    parser_train.add_argument('--with-dali', help='use dali for data loading', action='store_true', default=False)
